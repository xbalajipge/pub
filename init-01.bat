...
C:\Windows\System32\msiexec.exe /i ArcGISPro\ArcGISPro.msi /quiet /qn /l*vx arcgispro-install-log.txt INSTALLDIR="C:\arcgis\pro" ALLUSERS=1 ENABLEEUI=0 ACCEPTEULA=yes ESRI_LICENSE_HOST="@10.90.108.125;@10.90.108.229" SOFTWARE_CLASS=Professional AUTHORIZATION_TYPE=CONCURRENT_USE
